...
Supply Chain Analyst focused on operations automation. I build tools that eliminate manual work, reduce errors, and generate measurable savings in complex supply chain environments.

Currently working with Python, SAP S/4, logistics TMS APIs, and the Power Platform to automate operations.
...
```
Python  ·  pandas  ·  Selenium  ·  requests  ·  SQL
SAP S/4HANA  ·  Power Automate  ·  Power BI  ·  Power Apps
```

---

📍 Brisbane, Australia  
💼 [LinkedIn](https://linkedin.com/in/jmvaras)
